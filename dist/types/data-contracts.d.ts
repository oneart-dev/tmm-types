...
export declare enum ServicesWLCStatus {
    WLCStatusNone = 0,
    WLCStatusNew = 1,
...
export declare enum ServicesWidgetSource {
    ...
    WidgetSourceCommissionAccumulativeBNB = "commission_bnb_accumulative",
    WidgetSourceCommissionBNB = "commission_bnb",
    WidgetSourceBalance = "balance",
    WidgetSourceBalancePerApiKey = "balance_per_api_key",
    WidgetSourceBalancePerAsset = "spot_balance",
    ...
    WidgetSourceCountWinPerSymbol = "pie_symbol_winning",
    WidgetSourceCountLossPerSymbol = "pie_symbol_loosing",
    ...
    WidgetSourceMinMFE = "min_max_win_percent",
