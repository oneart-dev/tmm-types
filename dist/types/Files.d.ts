...
export declare class Files<SecurityDataType = unknown> extends HttpClient<SecurityDataType> {
    ...
    uploadTempDelete: (id: number, params?: RequestParams) => Promise<import("./http-client").HttpResponse<ControllersApiSuccessResponse, ControllersApiErrorResponse | ControllersApiWarningResponse | ControllersUnauthorizedResponse>>;
    uploadTempCreate: (intent: string, params?: RequestParams) => Promise<import("./http-client").HttpResponse<ControllersFilesResponse, string | ControllersApiErrorResponse | ControllersApiWarningResponse | ControllersUnauthorizedResponse>>;
