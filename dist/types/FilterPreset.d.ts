import { ControllersApiErrorResponse, ControllersApiSuccessResponse, ControllersApiSuccessServicesFilterPreset, ControllersFilterPresetsListResponse, ControllersUnauthorizedResponse, DtoFilterPresetCreateForm } from "./data-contracts";
...
export declare class FilterPreset<SecurityDataType = unknown> extends HttpClient<SecurityDataType> {
    ...
    filterPresetUpdate: (payload: DtoFilterPresetCreateForm, params?: RequestParams) => Promise<import("./http-client").HttpResponse<ControllersApiSuccessServicesFilterPreset, string | ControllersApiErrorResponse | ControllersUnauthorizedResponse>>;
