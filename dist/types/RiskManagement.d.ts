import { ControllersApiErrorResponse, ControllersApiSuccessArrayServicesRiskManagementBacktestResult, ControllersApiSuccessResponse, ControllersUnauthorizedResponse, DtoRiskManagementCreateForm, ServicesRiskManagementLogPagination, ServicesRiskManagementPagination } from "./data-contracts";
...
export declare class RiskManagement<SecurityDataType = unknown> extends HttpClient<SecurityDataType> {
    ...
    riskManagementCreate: (id: number, payload: DtoRiskManagementCreateForm, params?: RequestParams) => Promise<import("./http-client").HttpResponse<ControllersApiSuccessResponse, string | ControllersApiErrorResponse | ControllersUnauthorizedResponse>>;
