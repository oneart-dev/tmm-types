import { ControllersApiErrorResponse, ControllersApiSuccessArrayServicesCategory, ControllersApiSuccessArrayServicesOrder, ControllersApiSuccessArrayServicesTag, ControllersApiSuccessControllersUpdateDescBulkData, ControllersApiSuccessNoData, ControllersApiSuccessResponse, ControllersApiSuccessServicesSSETradeEventCatalog, ControllersApiSuccessServicesTag, ControllersApiSuccessServicesTagCategory, ControllersApiSuccessString, ControllersApiWarningResponse, ControllersOrdersListResponse, ControllersPublicTradeGroupResponse, ControllersPublicTradeResponse, ControllersTagCategoriesResponse, ControllersTagsResponse, ControllersUnauthorizedResponse, DtoCategoryListForm, DtoGlobalChartDataForm, DtoTagCategoryForm, DtoTagCategoryListForm, DtoTagForm, DtoTagsColumnBulkUpdateForm, DtoTagsSortForm, DtoTradeChartDataForm, DtoTradeChartForm, DtoTradeDrawingForm, DtoTradeGroupShortLink, DtoTradeUpdateDescBulkForm, DtoTradeUpdateDescForm, DtoTradeUpdateTagsBulkForm, DtoTradeUpdateTagsForm, DtoTradesCategoryForm, DtoTradesMergeForm, ServicesTradeChartResponse, ServicesTradesListPagination } from "./data-contracts";
...
export declare class Trades<SecurityDataType = unknown> extends HttpClient<SecurityDataType> {
    ...
    categoriesList: (params?: RequestParams) => Promise<import("./http-client").HttpResponse<ControllersApiSuccessArrayServicesCategory, string | ControllersApiErrorResponse | ControllersUnauthorizedResponse>>;
    categoriesCreate: (payload: DtoCategoryListForm, params?: RequestParams) => Promise<import("./http-client").HttpResponse<ControllersApiSuccessArrayServicesCategory, string | ControllersApiErrorResponse | ControllersUnauthorizedResponse>>;
    ...
    sseEventsList: (params?: RequestParams) => Promise<import("./http-client").HttpResponse<ControllersApiSuccessServicesSSETradeEventCatalog, any>>;
    tagCategoriesList: (params?: RequestParams) => Promise<import("./http-client").HttpResponse<ControllersTagCategoriesResponse, string | ControllersApiErrorResponse | ControllersApiWarningResponse | ControllersUnauthorizedResponse>>;
    tagCategoriesCreate: (payload: DtoTagCategoryListForm, params?: RequestParams) => Promise<import("./http-client").HttpResponse<ControllersTagCategoriesResponse, string | ControllersApiErrorResponse | ControllersApiWarningResponse | ControllersUnauthorizedResponse>>;
    tagCategoriesCreate2: (id: number, payload: DtoTagCategoryForm, params?: RequestParams) => Promise<import("./http-client").HttpResponse<ControllersApiSuccessServicesTagCategory, string | ControllersApiErrorResponse | ControllersApiWarningResponse | ControllersUnauthorizedResponse>>;
    tagCategoriesDelete: (id: number, params?: RequestParams) => Promise<import("./http-client").HttpResponse<ControllersApiSuccessNoData, string | ControllersApiErrorResponse | ControllersApiWarningResponse | ControllersUnauthorizedResponse>>;
    ...
    tagsColumnCreate: (payload: DtoTagsColumnBulkUpdateForm, params?: RequestParams) => Promise<import("./http-client").HttpResponse<ControllersApiSuccessNoData, string | ControllersApiErrorResponse | ControllersApiWarningResponse | ControllersUnauthorizedResponse>>;
    ...
    updateCategoryCreate: (payload: DtoTradesCategoryForm, params?: RequestParams) => Promise<import("./http-client").HttpResponse<ControllersApiSuccessArrayServicesCategory, string | ControllersApiErrorResponse | ControllersUnauthorizedResponse>>;
    updateNotesCreate: (payload: DtoTradeUpdateDescBulkForm, params?: RequestParams) => Promise<import("./http-client").HttpResponse<ControllersApiSuccessControllersUpdateDescBulkData, string | ControllersApiErrorResponse | ControllersApiWarningResponse | ControllersUnauthorizedResponse>>;
