import { ControllersApiErrorResponse, ControllersApiSuccessArrayServicesDashboard, ControllersApiSuccessInt64, ControllersApiSuccessNoData, ControllersApiSuccessServicesDashboard, ControllersApiSuccessServicesWidgetPreviewResponse, ControllersApiSuccessString, ControllersApiWarningResponse, ControllersLoadBoardEmbedResponse, ControllersLoadBoardResponse, ControllersLoadLayoutResponse, ControllersUnauthorizedResponse, ControllersWidgetUpdateResponse, DtoDashboardCreateForm, DtoDashboardExportForm, DtoDashboardShareForm, DtoDashboardUpdateForm, DtoDashboardsSortForm, DtoWidgetCreateForm, DtoWidgetShareForm, DtoWidgetUpdateForm, ServicesLoadBoardResponseChunk, ServicesValidationErrorResponse, ServicesWidgetCreateResponse } from "./data-contracts";
...
export declare class Board<SecurityDataType = unknown> extends HttpClient<SecurityDataType> {
    ...
    widgetCreate: (id: number, payload: DtoWidgetUpdateForm, params?: RequestParams) => Promise<import("./http-client").HttpResponse<ControllersWidgetUpdateResponse, string | ControllersApiErrorResponse | ControllersUnauthorizedResponse>>;
    ...
    widgetShortUrlCreate: (id: number, payload: DtoWidgetShareForm, params?: RequestParams) => Promise<import("./http-client").HttpResponse<ControllersApiSuccessString, string | ControllersApiErrorResponse | ControllersUnauthorizedResponse | ServicesValidationErrorResponse>>;
    ...
    shortUrlCreate: (id: number, payload: DtoDashboardShareForm, params?: RequestParams) => Promise<import("./http-client").HttpResponse<ControllersApiSuccessString, string | ControllersApiErrorResponse | ControllersApiWarningResponse | ControllersUnauthorizedResponse | ServicesValidationErrorResponse>>;
}
