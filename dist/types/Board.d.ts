...
export declare class Board<SecurityDataType = unknown> extends HttpClient<SecurityDataType> {
    ...
    boardCreate: (id: number, payload: DtoDashboardUpdateForm, params?: RequestParams) => Promise<import("./http-client").HttpResponse<ServicesWidgetCreateResponse, string | ControllersApiErrorResponse | ControllersUnauthorizedResponse>>;
