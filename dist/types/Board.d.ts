...
export declare class Board<SecurityDataType = unknown> extends HttpClient<SecurityDataType> {
    ...
    widgetShortUrlCreate: (id: number, payload: DtoWidgetShareForm, params?: RequestParams) => Promise<import("./http-client").HttpResponse<ControllersApiSuccessString, string | ControllersApiErrorResponse | ControllersUnauthorizedResponse>>;
