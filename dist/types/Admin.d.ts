import { ChatExportPayload, ControllersApiErrorResponse, ControllersApiSuccessArrayServicesArtifact, ControllersApiSuccessArrayServicesArtifactVersionDTO, ControllersApiSuccessArrayServicesFleetInstanceDTO, ControllersApiSuccessArrayServicesFleetNodeDTO, ControllersApiSuccessArrayServicesLeaguePointCheck, ControllersApiSuccessArrayServicesReferralWithdrawal, ControllersApiSuccessControllersFeedNotificationAdminCreateData, ControllersApiSuccessNoData, ControllersApiSuccessServicesExchangeRequestsAdminSummary, ControllersApiSuccessServicesFeedNotificationAnalyticsCounts, ControllersApiSuccessServicesFeedNotificationComment, ControllersApiWarningResponse, ControllersFeedNotificationAdminDetailResponse, ControllersFeedNotificationAdminUpdateResponse, ControllersFeedNotificationThreadDetailResponse, ControllersFeedNotificationThreadInboxResponse, ControllersFeedNotificationTranslationsPatchResponse, ControllersFleetSetTargetVersionForm, ControllersUnauthorizedResponse, DtoChatErrorResponse, DtoFeedNotificationCommentCreateForm, DtoFeedNotificationConversationStatusForm, DtoFeedNotificationCreateForm, DtoFeedNotificationTranslationsPatchForm, DtoFeedNotificationUpdateForm, DtoReferralWithdrawalActionForm, DtoReferralWithdrawalMarkPaidForm, DtoTicketQuickCreateForm, ServicesPaginationResponseArrayServicesFeedNotificationAdminListItem, ServicesPaginationResponseArrayServicesFeedNotificationRawVote, ServicesPaginationResponseArrayServicesFleetActivityDTO, ServicesValidationErrorResponse } from "./data-contracts";
...
export declare class Admin<SecurityDataType = unknown> extends HttpClient<SecurityDataType> {
    ...
    exchangeRequestsList: (query?: {
        days?: number;
    }, params?: RequestParams) => Promise<import("./http-client").HttpResponse<ControllersApiSuccessServicesExchangeRequestsAdminSummary, ControllersApiErrorResponse | ControllersUnauthorizedResponse | ServicesValidationErrorResponse>>;
    ...
    notificationsTranslationsUpdate: (id: number, payload: DtoFeedNotificationTranslationsPatchForm, params?: RequestParams) => Promise<import("./http-client").HttpResponse<ControllersFeedNotificationTranslationsPatchResponse, ControllersApiErrorResponse | ServicesValidationErrorResponse>>;
    ...
    referralWithdrawalsList: (query?: {
        status?: string;
    }, params?: RequestParams) => Promise<import("./http-client").HttpResponse<ControllersApiSuccessArrayServicesReferralWithdrawal, ControllersApiErrorResponse | ControllersUnauthorizedResponse | ServicesValidationErrorResponse>>;
    referralWithdrawalsMarkPaidCreate: (id: number, payload: DtoReferralWithdrawalMarkPaidForm, params?: RequestParams) => Promise<import("./http-client").HttpResponse<ControllersApiSuccessNoData, ControllersApiErrorResponse | ControllersApiWarningResponse | ControllersUnauthorizedResponse | ServicesValidationErrorResponse>>;
    referralWithdrawalsRejectCreate: (id: number, payload: DtoReferralWithdrawalActionForm, params?: RequestParams) => Promise<import("./http-client").HttpResponse<ControllersApiSuccessNoData, ControllersApiErrorResponse | ControllersApiWarningResponse | ControllersUnauthorizedResponse | ServicesValidationErrorResponse>>;
