import { ControllersApiErrorResponse, ControllersApiSuccessArrayServicesLeaguePointCheckPublicItem, ControllersApiSuccessArrayServicesReferralWithdrawal, ControllersApiSuccessResponse, ControllersApiSuccessServicesPromoCodeApplyResult, ControllersApiSuccessServicesPromoCodePreview, ControllersApiSuccessServicesReferralDashboard, ControllersApiSuccessServicesReferralWithdrawal, ControllersApiWarningResponse, ControllersBulkSignUpSuccessResponse, ControllersLoginSuccessResponse, ControllersPublicProfileResponse, ControllersPublicProfileStatsResponse, ControllersReferralSummaryResponse, ControllersTopTradersSuccessResponse, ControllersUnauthorizedResponse, DtoPasswordResetCredentials, DtoPromoCodeApplyForm, DtoPromoCodePreviewForm, DtoPublicProfileUpdateForm, DtoReferralWithdrawalCreateForm, DtoUserLanguage, DtoUserReferralCode, DtoUserTheme, DtoUserUpdateForm, ServicesGuideProgress, ServicesPublicProfileLayoutChunk, ServicesTradesListPagination, ServicesValidationErrorResponse } from "./data-contracts";
...
export declare class Users<SecurityDataType = unknown> extends HttpClient<SecurityDataType> {
    ...
    myPublicProfileLoadList: (params?: RequestParams) => Promise<import("./http-client").HttpResponse<ServicesPublicProfileLayoutChunk, string | ControllersApiErrorResponse | ControllersUnauthorizedResponse>>;
    promoCodesApplyCreate: (payload: DtoPromoCodeApplyForm, params?: RequestParams) => Promise<import("./http-client").HttpResponse<ControllersApiSuccessServicesPromoCodeApplyResult, ControllersApiErrorResponse | ServicesValidationErrorResponse>>;
    promoCodesPreviewCreate: (payload: DtoPromoCodePreviewForm, params?: RequestParams) => Promise<import("./http-client").HttpResponse<ControllersApiSuccessServicesPromoCodePreview, ControllersApiErrorResponse | ServicesValidationErrorResponse>>;
    ...
    referralDashboardList: (params?: RequestParams) => Promise<import("./http-client").HttpResponse<ControllersApiSuccessServicesReferralDashboard, ControllersApiErrorResponse | ControllersUnauthorizedResponse>>;
    referralWithdrawalsList: (params?: RequestParams) => Promise<import("./http-client").HttpResponse<ControllersApiSuccessArrayServicesReferralWithdrawal, ControllersApiErrorResponse | ControllersUnauthorizedResponse>>;
    referralWithdrawalsCreate: (payload: DtoReferralWithdrawalCreateForm, params?: RequestParams) => Promise<import("./http-client").HttpResponse<ControllersApiSuccessServicesReferralWithdrawal, ControllersApiErrorResponse | ControllersApiWarningResponse | ControllersUnauthorizedResponse>>;
    ...
    topTradersPointsLogList: (params?: RequestParams) => Promise<import("./http-client").HttpResponse<ControllersApiSuccessArrayServicesLeaguePointCheckPublicItem, ControllersApiErrorResponse | ControllersUnauthorizedResponse>>;
