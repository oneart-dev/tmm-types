import { ControllersUnauthorizedResponse, DtoChatCreateThreadRequest, DtoChatCreateThreadResponse, DtoChatDeleteResponse, DtoChatErrorResponse, DtoChatGetThreadResponse, DtoChatListThreadsResponse, DtoChatProfileRebuildResponse, DtoChatQuotaExceededResponse, DtoChatSendMessageRequest, DtoChatSendMessageResponse, DtoChatUsageResponse } from "./data-contracts";
...
export declare class Chat<SecurityDataType = unknown> extends HttpClient<SecurityDataType> {
    ...
    threadsCreate: (request: DtoChatCreateThreadRequest, params?: RequestParams) => Promise<import("./http-client").HttpResponse<DtoChatCreateThreadResponse, ControllersUnauthorizedResponse | DtoChatErrorResponse | DtoChatQuotaExceededResponse>>;
    ...
    threadsMessagesCreate: (uid: string, request: DtoChatSendMessageRequest, params?: RequestParams) => Promise<import("./http-client").HttpResponse<DtoChatSendMessageResponse, ControllersUnauthorizedResponse | DtoChatErrorResponse | DtoChatQuotaExceededResponse>>;
