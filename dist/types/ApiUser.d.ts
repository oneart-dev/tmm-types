import { ControllersApiErrorResponse, ControllersApiSuccessControllersApiUserNewsTokenData, ControllersApiSuccessResponse, ControllersApiUsersListResponse, ControllersUnauthorizedResponse, DtoApiUserUpdateForm, ServicesValidationErrorResponse } from "./data-contracts";
...
export declare class ApiUser<SecurityDataType = unknown> extends HttpClient<SecurityDataType> {
    ...
    putApiUser: (params?: RequestParams) => Promise<import("./http-client").HttpResponse<ControllersApiSuccessResponse, string | ControllersApiErrorResponse | ControllersUnauthorizedResponse>>;
    newsUpdate: (params?: RequestParams) => Promise<import("./http-client").HttpResponse<ControllersApiSuccessControllersApiUserNewsTokenData, string | ControllersApiErrorResponse | ControllersUnauthorizedResponse>>;
